...
def fetch_recommendations_node(state: AgentState, ticker: str) -> AgentState:
    """
...
def fetch_fundamentals_node(state: AgentState, ticker: str) -> AgentState:
    """
...
def fetch_news_node(state: AgentState, ticker: str) -> AgentState:
    """
    ...
    return AgentState(**{**state, "ticker": ticker, "ticker_info": stock_news})
